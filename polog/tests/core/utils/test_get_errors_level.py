...
def test_get_base_level():
    ...
    """
    assert get_errors_level(None) == SettingsStore()['default_error_level']
...
def test_error_level():
    ...
    """
    assert get_errors_level('lolkekololo') == SettingsStore()['default_error_level']
    assert get_errors_level(-500) == SettingsStore()['default_error_level']
