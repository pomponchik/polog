...
- **Система уровней очень гибкая**. Можно давать [им](#уровни-логирования) произвольные имена и пользоваться ими так, будто они были встроены изначально. В большинстве других логгеров уровни "прибиты гвоздями".
