...
Также вы можете указать уровень логирования для обычных событий в виде числа:
...
В примере выше локальные обработчики полностью исключают любые установленные глобально. Если вы хотите, чтобы работали и те и другие, укажите в конце списка троеточие:
