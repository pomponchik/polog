...
Обработчик логов - это некая функция, которую Polog вызывает для каждого логируемого события. Вы можете написать свой обработчик и зарегистрировать его в логгере. К примеру, она может отправлять логи в вашу любимую NoSQL базу данных, писать их в файловую систему, выводить в консоль, или писать вам в мессенджерах / соцсетях.
