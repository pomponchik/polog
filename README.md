...
- Возможность писать собственные **расширения** или пользоваться встроенными. К примеру, при помощи встроенного расширения вы можете настроить отправку уведомлений об ошибках на ваших сервисах по электронной почте.
