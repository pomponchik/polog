...
- **Гибкая система уровней логирования**. Вы можете создавать собственные уровни, давать им произвольные названия и пользоваться ими так, будто они были встроены изначально.
