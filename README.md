...
Как уже упоминалось выше, Polog управляет базой данных с помощью [Pony ORM](https://ponyorm.org/). Pony была выбрана в первую очередь за свой самый лаконичный и самый питонячий язык запросов, а также за самую высокую скорость работы.
