...
- Есть **более 560 тестов**, которые обеспечивают покрытие более чем на **96%**. И стремление эти цифры еще увеличить.
...
Или даже так (но этот способ не поддерживает использование методов и атрибутов, про которые вы прочитаете далее):
