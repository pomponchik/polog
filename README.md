...
- Возможность писать собственные **расширения** или пользоваться встроенными. К примеру, вы можете настроить отправку уведомлений об ошибках по электронной почте.
