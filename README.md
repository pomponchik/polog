...
- **Автоматическое логирование через декоратор**, причем декорировать можно как [функции и методы](#декорируем-функции), так и [целые классы](#декорируем-классы). Это снижает трудозатраты для программиста, и в то же время делает логи более стандартизированными и качественными.
...
- **Возможность редактировать лог, записываемый декоратором, изнутри той функции, которую он оборачивает**. [Эта возможность](#редактируем-автоматические-логи-из-задекорированных-функций) делает логирование через декоратор таким же мощным, как обычное, и в то же время - гораздо более минималистичным.
