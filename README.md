...
> Важно: этот и другие приведенные примеры ручного логирования могут работать немного странно, если запускать их через [REPL](https://docs.python.org/3/tutorial/interpreter.html#interactive-mode).
